...
Serves static files and JSON with compression, constrained to 16 CPUs and 32 GB memory. Same workload as [Assets-4](../assets-4) but with more resources to measure scaling behavior.
