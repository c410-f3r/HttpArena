...
Serves static files and JSON with compression, constrained to 4 CPUs and 16 GB memory. Tests how efficiently a framework handles mixed asset serving with on-the-fly compression under limited resources.
