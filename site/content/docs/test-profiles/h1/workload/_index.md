...
{{< cards >}}
  ...
  {{< card link="assets-4" title="Assets-4" subtitle="Static files and JSON with compression, constrained to 4 CPUs. Tests asset serving efficiency." icon="photograph" >}}
