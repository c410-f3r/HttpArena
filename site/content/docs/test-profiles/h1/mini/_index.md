...
Same mixed workload as the [Mixed Workload](../mixed) test but with the server constrained to 4 CPUs and 16 GB memory. Measures how efficiently a framework performs under limited resources.
