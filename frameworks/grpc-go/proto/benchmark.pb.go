...
const file_proto_benchmark_proto_rawDesc = "" +
	...
	"\bSumReply\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06result2H\n" +
	"\x10BenchmarkService\x124\n" +
	"\x06GetSum\x12\x15.benchmark.SumRequest\x1a\x13.benchmark.SumReplyB\x0fZ\rgrpc-go/protob\x06proto3"
...
var file_proto_benchmark_proto_goTypes = []any{
	(*SumRequest)(nil), // 0: benchmark.SumRequest
	(*SumReply)(nil),   // 1: benchmark.SumReply
}
var file_proto_benchmark_proto_depIdxs = []int32{
	0, // 0: benchmark.BenchmarkService.GetSum:input_type -> benchmark.SumRequest
	1, // 1: benchmark.BenchmarkService.GetSum:output_type -> benchmark.SumReply
