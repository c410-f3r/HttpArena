...
check "GET /baseline11?a=13&b=42" "55" "http://localhost:$PORT/baseline11?a=13&b=42"

# Test 2: POST with Content-Length body
check "POST /baseline11?a=13&b=42 + CL body=20" "75" \
    -X POST -H "Content-Type: text/plain" -d "20" "http://localhost:$PORT/baseline11?a=13&b=42"
